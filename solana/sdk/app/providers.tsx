...
export function Providers({ children }: { children: ReactNode }) {
  ...
  const connectionConfig = useMemo(() => ({
    ...
    wsEndpoint: "wss://devnet.helius-rpc.com/?api-key=" + process.env.NEXT_PUBLIC_HELIUS_API_KEY,
    httpHeaders: {
...
// Header component with theme toggle and wallet button
function Header() {
